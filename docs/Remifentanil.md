...
<label for="konz">Konzentration (ug/ml):</label><br>
<select id="konz">
  <option value="20">20 ug/ml (1 mg/50 ml)</option>
  <option value="40" selected>40 ug/ml (2 mg/50 ml)</option>
  <option value="100">100 ug/ml (5 mg/50 ml)</option>
</select><br><br>

<label for="dosis">Dosierung (ug/kg/min):</label><br>
<select id="dosis">
