...
---
## 🚨 CAVE / MERKE 💡
- Akute, potenziell lebensbedrohliche **Überstimulation serotonerger Rezeptoren**  
- Typische **Trias**:  
	→ neuromuskuläre, vegetative und psychische Symptome    
...
---
## ❓ URSACHEN
- **Antidepressiva**: SSRI, SNRI, MAO-Hemmer, TCA  
- **Analgetika**: Tramadol, Pethidin, Fentanyl, Methadon  
- **Antiemetika**: [Ondansetron](Ondansetron.md), Granisetron  
...
## 🏥 THERAPIE
- **Sofortiges Absetzen** serotonerger Substanzen  
- **Supportiv**:  
	→ Kühlung, Volumen, Benzodiazepine (Sedierung, Muskelrelaxation)  
- **Intensivpflichtig** bei schwerem Verlauf mit:  
	→ Hyperthermie > 41 °C (→ CoolGuard)
	→ Krampfanfälle
	→ Rhabdomyolyse  
- **Keine** Antipyretika  
	→ Hyperthermie ist zentral vermittelt  
- Sedierung:  
	→ frühzeitig beginnen
	→ zur Reduktion neuromuskulärer Überaktivität
- **Spezifisch**:  
	→ *Cyproheptadin* (Serotonin-Antagonist, p.o.)  
	→ selten im OP verfügbar  

<details>
  <summary>💊 Dosierung: Cyproheptadin</summary>
  <table>
    <thead>
      <tr>
        <th>Applikationsform</th>
        <th>Initialdosis</th>
        <th>Erhaltungsdosis</th>
        <th>Hinweise</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td>p.o.</td>
        <td>12 mg einmalig</td>
        <td>2 mg alle 2 h bis max. 32 mg/Tag</td>
        <td>Serotonin-Antagonist, Off-Label bei schwerem serotonergen Syndrom</td>
      </tr>
    </tbody>
  </table>
  ...
  <h4>⚠️ Cave</h4>
  <ul>
    <li>Nur oral verfügbar → perioperativ eingeschränkt nutzbar</li>
    <li>Anticholinerge Nebenwirkungen beachten (Mundtrockenheit, Sedierung)</li>
    <li>Off-Label-Einsatz, keine standardisierte Empfehlung in Leitlinien</li>
  </ul>
</details>
...
<details>
  ...
  <table>
    ...
    <tbody>
      ...
      <tr><td>MNS</td><td>Malignes neuroleptisches Syndrom</td></tr>
      <tr><td>MAO</td><td>Monoaminooxidase</td></tr>
      <tr><td>MDMA</td><td>3,4-Methylendioxy-N-Methylamphetamin</td></tr>
      ...
      <tr><td>TCA</td><td>Trizyklische Antidepressiva</td></tr>
    </tbody>
  </table>
</details>
...
<details>
  ...
  <ul>
    <li>Boyer EW, Shannon M. *The Serotonin Syndrome*. N Engl J Med. 2005;352:1112–1120.</li>
    <li>Gillman PK. *Serotonin toxicity: a practical approach to diagnosis and treatment*. Med J Aust. 2010;193(6):364–369.</li>
    <li>Volpi-Abadie J, Kaye AM, Kaye AD. *Serotonin syndrome*. Ochsner J. 2013;13(4):533–540.</li>
    <li>AWMF S3-Leitlinie: *Analgesie und Sedierung in der Intensivmedizin*. 2022.</li>
  </ul>
</details>

<details>
  <summary>🏷️ Tags</summary>
  <p>#Anästhesie #Pharmakologie #Notfallmedizin #Serotonin #Syndrom #Perioperativ</p>
</details>