...
<table class="color-table">
  <thead>
    <tr>
      <th style="background: var(--header-bg); color: var(--text-color);">Score</th>
      <th style="background: var(--header-bg); color: var(--text-color);">Jährliches Schlaganfallrisiko</th>
      <th style="background: var(--header-bg); color: var(--text-color);">Interpretation</th>
    </tr>
  </thead>
